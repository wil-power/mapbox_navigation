...
import com.example.mapboxnav.R;
...
public class MainActivity extends AppCompatActivity implements OnNavigationReadyCallback,
    ...
    private static final Point ORIGIN = Point.fromLngLat(-0.3086696, 5.639307);
    private static final Point DESTINATION = Point.fromLngLat(-0.3063035, 5.6358248);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(getApplicationContext(), "pk.eyJ1Ijoid2lsZnJlZGFneWVpIiwiYSI6ImNqb2Vrc2pkdDF4dWIza2xlbm5yZGh6aWgifQ.l5R6Hnm-G1i3MK_x4R2NRQ");
    ...
    public void onNavigationFinished() {
        // Intentionally empty
        Toast.makeText(this, "reached destination", 3000).show();
    ...
    public void onNavigationRunning() {
        // Intentionally empty
        Toast.makeText(this, "started navigating", 3000).show();
